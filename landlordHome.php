<?php
/*This is the home page for the users with an authenticated landlord account.
...
<!-- ============ MAIN CONTENT ============== -->
	<td width="80%" valign="top" bgcolor="#d2d8c7">
		<p >Ad Postings from Landlords</p>
		<hr>
		<div class="titleprh">Showing 1 - 5 out of 
		<?php
		/*Used to output total ads posted by landlords that are approved.*/
		//Database information is retrieved
			...
			$output2 = $db->query("select COUNT(*) from `tlaadvertisement` where status = 'Approved' and account_type = 'landlord'");
	...
	<!-- Generate advertisment listing of ads posted by Landlords -->
