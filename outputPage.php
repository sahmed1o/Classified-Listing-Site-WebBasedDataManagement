<?php
/*Displays the advertisement that the user clicked on in full detail referencing the id
with a GET request.
...
try {
	...
	//this is mainly to extract info about the poster and ad
		...
		$action2 = $output2->fetch(PDO::FETCH_ASSOC);
		 ...
		 //Send an email to the ad poster using the email and ad title gathered from the advertisement ID, and send an email
